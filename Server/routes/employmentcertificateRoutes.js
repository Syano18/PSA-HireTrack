...
router.post('/send-email-employment-certificate', async (req, res) => {
  const data = req.body;
  ...
  try {
    ...
    try {
      ...
      console.error('[send-email-employment] Could not fetch existing row:', lookupErr.message);
    }
    ...
    const doc = new PDFDocument({
      ...
      layout: 'landscape',
      margin: 0,
      info: { Title: 'Employment Certificate', Author: 'Philippine Statistics Authority Kalinga' },
