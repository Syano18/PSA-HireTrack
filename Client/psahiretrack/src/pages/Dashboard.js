    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-900">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                >
                    <div>
                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Employments</p>
                ...
                >
                    <div>
                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Employments</p>
                        <p className="text-3xl font-bold text-gray-900 dark:text-white">{dashboardData.activeEmployments}</p>
                    </div>
